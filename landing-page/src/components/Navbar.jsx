    ...
    <div className='fixed w-full h-[150px] flex justify-between items-center px-4 bg-white'>
        ...
        <ul className='hidden md:flex'>
            ...
            <li className="relative" data-te-dropdown-ref>
                ...
                <ul
                    className="absolute z-[1000] float-left m-0 hidden min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg bg-[#676766] [&[data-te-dropdown-show]]:block"
