...
function Edesign() {
  return (
    <div name='edesign' className='w-full h-screen'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col sm:flex-row sm:justify-center items-center w-full h-full'>
            <div className='max-w-[100] sm:max-w-[50%] text-center sm:text-left flex flex-col items-center sm:items-start'>
                ...
                <a className='text-[#676766] border-2 px-6 py-3 my-2 flex items-center hover:bg-[#E5C1C1] hover:border-[#E5C1C1] hover:text-white' href='https://www.rughdesign.com/product/new-build-edesign/' target='_blank'>Hire me!</a>
            </div>
