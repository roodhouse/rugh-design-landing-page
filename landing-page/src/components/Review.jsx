  ...
  return (
    <div className='w-full h-fit sm:h-screen'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col sm:flex-row justify-normal sm:justify-center w-full h-full gap-20'>
            <div name='scheme' className='max-w-[100%] sm:max-w-[50%] h-fit flex flex-col items-center sm:rounded-lg sm:bg-white sm:shadow-lg'>
            ...
            <div name='review' className='max-w-[100%] sm:max-w-[50%] h-fit flex flex-col items-center sm:rounded-lg sm:bg-white sm:shadow-lg'>
