    ...
    <div name='work' className='w-full h-screen'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col sm:flex-row justify-center w-full h-full'>
            <div className='max-w-[100%] text-center sm:text-right flex flex-col items-center sm:items-end'>
                ...
                <div className='flex flex-row flex-wrap gap-1 justify-center pb-4'>
                    <img className='max-w-[25%] h-fit border-2 border-[#E5C1C1]' src={PortOne} alt="Agreeable-Gray SW 7029 with Cityscape SW 7067 and Extra White SW 7006" />
                    <img className='max-w-[25%] h-fit border-2 border-[#E5C1C1]' src={PortTwo} alt="Sherwin-Williams Balanced Beige SW 7037 in open space" />
                    <img className='max-w-[25%] h-fit border-2 border-[#E5C1C1]' src={PortThree} alt="Open layout kitchen with Amazing Gray SW 7044 cabinets and White Duck SW 7010 walls" />
                    <img className='max-w-[25%] h-fit border-2 border-[#E5C1C1]' src={PortFour} alt="Balanced Beige Kitchen walls with Creamy Cabinets" />
                    <img className='max-w-[25%] h-fit border-2 border-[#E5C1C1]' src={PortFive} alt="Shoji White on exterior" />
                    <img className='max-w-[25%] h-fit border-2 border-[#E5C1C1]' src={PortSix} alt="Front porch" />
                </div>
