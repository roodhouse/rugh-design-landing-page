    ...
    <div name='samples' className='w-full h-screen'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col sm:flex-row justify-center w-full h-full'>
            ...
            <div className='max-w-[100%] sm:max-w-[50%] text-center sm:text-right flex flex-col items-center sm:items-end'>
                ...
                <a className='text-[#676766] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#E5C1C1] hover:border-[#E5C1C1] hover:text-white' href='https://www.rughdesign.com/product-category/paint-samples/?orderby=popularity' target='_blank'>Find your color!</a>
            </div>
        </div>
    </div>
  )
