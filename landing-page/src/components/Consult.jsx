    ...
    <div name='consult' className='w-full h-screen'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col sm:flex-row justify-center w-full h-full'>
            <div className='max-w-[100%] sm:max-w-[50%] text-center sm:text-left flex flex-col items-center sm:items-start'>
                ...
                <a className='text-[#676766] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#E5C1C1] hover:border-[#E5C1C1] hover:text-white' href='https://www.rughdesign.com/product/interior-color-consultation/' target='_blank'>Hire me!</a>
            </div>
            <div className='max-w-[100%] sm:max-w-[50%] order-first sm:order-last pb-4 sm:pb-0'>
                <img className='mx-[0%] sm:mx-[25%] max-w-[100%] sm:max-w-[50%]' src={Interior} alt="Interior Color Consultation" />
            </div>
        </div>
    </div>
  )
